"""
Cortex Analyst Conversational App
====================
This app allows users to interact with HL7 FHIR structured data using natural language question asking.
"""
...
AVAILABLE_SEMANTIC_MODELS_PATHS = [
    "HL7_FHIR.HARMONIZED.CORTEX_ANALYST_STAGE/hl7_fhir_r4_semantic_model.yaml"
]
...
def show_header_and_sidebar():
    ...
    st.title("🧠⚕️ Cortex Analyst Healthcare")
    st.markdown(
        "Welcome to Cortex Analyst! Type your questions below to interact with healthcare data. "
    )
